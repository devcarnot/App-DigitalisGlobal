        ...
        <div className="p-6 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="self-start rounded-xl bg-gradient-to-r from-slate-900 via-[#103D4D] to-teal-600 px-5 py-2.5 text-sm font-bold text-white disabled:opacity-50 shadow-lg shadow-teal-900/25 hover:from-slate-950 hover:to-teal-700 hover:shadow-xl transition-all"
            >
