...
function MessagesInner() {
  ...
  return (
    <div
      className="mx-auto flex h-full min-h-0 w-full max-w-[min(100%,96rem)] flex-1 flex-col overflow-hidden max-lg:bg-white max-lg:dark:bg-[#0a1218] lg:bg-[color:var(--erp-canvas-light)] lg:dark:bg-[#0a1218] lg:gap-4"
    >
