...
function MemberDayBar({ minutes, outcome, title, isToday, maxMinutes }) {
  ...
  return (
    <div
      className="flex min-w-[1.35rem] flex-1 flex-col items-center gap-0.5"
      title={title}
    >
      ...
      <div className="border-b border-slate-100 bg-gradient-to-r from-white via-slate-50/40 to-sky-50/30 px-4 py-3.5 dark:border-teal-900/35 dark:from-[#0c121a] dark:via-[#0c121a] dark:to-sky-950/10 sm:px-[18px]">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400">
            {view === 'grid' ? 'Day outcome per cell' : 'Daily net hours per member'} · tap for detail
          </p>
                    ...
                    {days.map((d) => {
                      ...
                      return (
                        <div
                          ...
                          className={`mx-auto h-[24px] w-full max-w-[36px] rounded-[5px] transition-transform hover:scale-110 hover:shadow-md ${meta.cell} ${
