...
export const ERP_NAV_BLUEPRINT = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/erp/attendance', label: 'Attendance', iconId: 'calendar', module: 'attendance' },
      { href: '/erp/admin/attendance', label: 'Attendance', iconId: 'calendar', module: 'attendance_admin' },
...
export function erpNavFilterSections(blueprint, canView) {
  return blueprint
    .map((sec) => ({
      ...sec,
      items: sec.items.filter((it) => canView(it.module)),
    }))
