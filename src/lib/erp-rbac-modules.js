...
export const ERP_RBAC_MODULE_META = {
  ...
  files: { label: 'Files', group: 'work', sort: 3 },
  messages: { label: 'Messages', group: 'communication', sort: 4 },
  clients: { label: 'Clients', group: 'communication', sort: 5 },
  meetings: { label: 'Meetings', group: 'communication', sort: 6 },
  members: { label: 'Members (admin)', group: 'hr', sort: 7 },
  attendance: { label: 'Attendance (self)', group: 'hr', sort: 8 },
  attendance_admin: { label: 'Attendance (admin)', group: 'hr', sort: 9 },
  leave: { label: 'Leave', group: 'hr', sort: 10 },
  remote: { label: 'Remote / time', group: 'hr', sort: 11 },
  performance: { label: 'Performance', group: 'reports', sort: 12 },
  statistics: { label: 'Statistics', group: 'reports', sort: 13 },
  finance: { label: 'Finance', group: 'reports', sort: 14 },
  inbox: { label: 'Recent activity', group: 'system', sort: 15 },
  trash: { label: 'Trash', group: 'system', sort: 16 },
  settings: { label: 'Admin settings', group: 'system', sort: 17 },
  settings_roles: { label: 'Roles & permissions', group: 'system', sort: 18 },
};
