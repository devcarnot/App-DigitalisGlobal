...
export const ERP_RBAC_MODULE_META = {
  ...
  notes: {
    ...
    group: 'work',
    sort: 3,
    description: "Personal Kanban board for what's next. Each user only sees their own notes.",
  },
  ...
  announcements: { label: 'Announcements', group: 'communication', sort: 8 },
  members: { label: 'Members (admin)', group: 'hr', sort: 9 },
  attendance: { label: 'Attendance (self)', group: 'hr', sort: 10 },
  attendance_admin: { label: 'Attendance (admin)', group: 'hr', sort: 11 },
  leave: { label: 'Leave', group: 'hr', sort: 12 },
  remote: { label: 'Remote / time', group: 'hr', sort: 13 },
  performance: { label: 'Performance', group: 'reports', sort: 14 },
  statistics: { label: 'Statistics', group: 'reports', sort: 15 },
  finance: { label: 'Finance', group: 'reports', sort: 16 },
  inbox: { label: 'Recent activity', group: 'system', sort: 17 },
  trash: { label: 'Trash', group: 'system', sort: 18 },
  settings: { label: 'Admin settings', group: 'system', sort: 19 },
  settings_roles: { label: 'Roles & permissions', group: 'system', sort: 20 },
};
...
const CLIENT = {
  ...
  announcements: g(false, false, false, false),
  members: g(false, false, false, false),
