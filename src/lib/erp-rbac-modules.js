...
export const ERP_RBAC_MODULE_META = {
  ...
  members: { label: 'Members (admin)', group: 'hr', sort: 6 },
  attendance: { label: 'Attendance (self)', group: 'hr', sort: 7 },
  attendance_admin: { label: 'Attendance (admin)', group: 'hr', sort: 8 },
  leave: { label: 'Leave', group: 'hr', sort: 9 },
  remote: { label: 'Remote / time', group: 'hr', sort: 10 },
  performance: { label: 'Performance', group: 'reports', sort: 11 },
  statistics: { label: 'Statistics', group: 'reports', sort: 12 },
  finance: { label: 'Finance', group: 'reports', sort: 13 },
  inbox: { label: 'Recent activity', group: 'system', sort: 14 },
  trash: { label: 'Trash', group: 'system', sort: 15 },
  settings: { label: 'Admin settings', group: 'system', sort: 16 },
  settings_roles: { label: 'Roles & permissions', group: 'system', sort: 17 },
};
