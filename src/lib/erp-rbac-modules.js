...
export const ERP_RBAC_MODULE_META = {
  ...
  reminders: {
    ...
    group: 'communication',
    sort: 8,
    description: 'Schedule reminders for yourself. Super Admin can assign reminders to any team member.',
  },
  ...
  attendance_admin: { label: 'Attendance (admin)', group: 'hr', sort: 12, description: 'Super Admin and Team Manager can view team check-ins, undo accidental check-outs within 2 hours, and edit times.' },
  ...
  statistics: { label: 'Statistics', group: 'reports', sort: 16 },
